...
#define LC_ACTION_SHEET_BUTTON_HEIGHT       56.0f
...
#define LC_ACTION_SHEET_ANIMATION_DURATION  0.2f

#define LC_ACTION_SHEET_DARK_OPACITY        0.4f
...
- (UIFont *)titleFont {
    if (!titleFont) {
        titleFont = kFont(16 * autoLayoutY);
    }
    return titleFont;
}
...
- (UIFont *)buttonFont {
    if (!buttonFont) {
        buttonFont = kFont(16 * autoLayoutY);
    }
    return buttonFont;
}
